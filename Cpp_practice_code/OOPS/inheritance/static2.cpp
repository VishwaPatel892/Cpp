...
class CodingGita{
    ...
    // static fucnrion members...
    
        static void display2(){
            cout <<"The static fucntion belongs to class codinggita not to it's individual object" << endl;
            
        }

        
        static void display1(CodingGita& student){
            cout <<"The static fucntion belongs to class codinggita not to it's individual object" << endl;
            student.display();
            CodingGita::display2();
        }
